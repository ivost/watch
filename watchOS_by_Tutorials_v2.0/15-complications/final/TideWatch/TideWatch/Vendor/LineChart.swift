...
private class Helpers {
  ...
  */
  private class func UIColorFromHex(_ hex: Int) -> UIColor {
...
public class LineChart: UIView {
  ...
  override public func draw(_ rect: CGRect) {
    ...
    guard dataStore.count > 0 else { return }
  ...
  * Draw line.
  */
  private func drawLine(_ lineIndex: Int) {
  ...
  */
  private func drawAreaBeneathLineChart(_ lineIndex: Int) {
...
public class LinearScale {
  ...
  private func bilinear(_ domain: [CGFloat], range: [CGFloat], uninterpolate: ((_ a: CGFloat, _ b: CGFloat) -> ((_ c: CGFloat) -> CGFloat)), interpolate: ((_ a: CGFloat, _ b: CGFloat) -> ((_ c: CGFloat) -> CGFloat))) -> ((_ c: CGFloat) -> CGFloat) {
    let u = uninterpolate(domain[0], domain[1])
    let i = interpolate(range[0], range[1])
